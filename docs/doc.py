...
def doc(doc_id: str):
    ...
    md = Panel(Markdown(md_file, inline_code_lexer=core.lexer, style=special_style, inline_code_theme="ansi_dark", code_theme="ansi_dark"), title=doc_id, border_style="yellow")
