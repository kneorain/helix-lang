    ...
    *_mark: tuple[Any] | str,
    ...
    if not multi_frame:
        ...
        if False:
            ...
            propagation: str = (" Propagated from the following " if pos == 1 else " Caused by ").center(((terminal_width - 2 - (len(name) if len(name) % 2 == 0 else len(name) - 1)) - 8), chars["dash"]) + reset  # type: ignore
