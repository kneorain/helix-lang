...
from src.functions._include import include as _include
from src.functions._functions import function as _function
from src.functions._async_pre import async_prefixed as _async_pre
from src.classes._ast import AST_LIST



def dummy(line: AST_LIST, current_scope, parent_scope, root_scope) -> str:
